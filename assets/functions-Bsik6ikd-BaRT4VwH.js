var z=s=>{throw TypeError(s)};var U=(s,t,e)=>t.has(s)||z("Cannot "+e);var _=(s,t,e)=>(U(s,t,"read from private field"),e?e.call(s):t.get(s)),B=(s,t,e)=>t.has(s)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(s):t.set(s,e),y=(s,t,e,i)=>(U(s,t,"write to private field"),i?i.call(s,e):t.set(s,e),e);var m,Z;class g1{constructor(t){B(this,m);B(this,Z,new Set);y(this,m,t)}get current(){return _(this,m)}set current(t){_(this,m)!=t&&(y(this,m,t),_(this,Z).forEach(e=>e(t)))}on(t){return _(this,Z).add(t),()=>_(this,Z).delete(t)}}m=new WeakMap,Z=new WeakMap;const K=s=>new g1(s),O=Symbol.for("atomico.hooks");globalThis[O]=globalThis[O]||{};let P=globalThis[O];const p1=Symbol.for("Atomico.suspense"),X=Symbol.for("Atomico.effect"),Q=Symbol.for("Atomico.layoutEffect"),W=Symbol.for("Atomico.insertionEffect"),q=(s,t,e)=>{const{i,hooks:o}=P.c,c=o[i]=o[i]||{};return c.value=s(c.value),c.effect=t,c.tag=e,P.c.i++,o[i].value},f1=s=>q((t=K(s))=>t),w1=()=>q((s=K(P.c.host))=>s),s5=()=>P.c.update,d1=(s,t,e=0)=>{let i={},o=!1;const c=()=>o,C=(a,g)=>{for(const p in i){const h=i[p];h.effect&&h.tag===a&&(h.value=h.effect(h.value,g))}};return{load:a=>{P.c={host:t,hooks:i,update:s,i:0,id:e};let g;try{o=!1,g=a()}catch(p){if(p!==p1)throw p;o=!0}finally{P.c=null}return g},cleanEffects:a=>(C(W,a),()=>(C(Q,a),()=>{C(X,a)})),isSuspense:c}},b=Symbol.for;function u1(s,t){const e=s.length;if(e!==t.length)return!1;for(let i=0;i<e;i++){let o=s[i],c=t[i];if(o!==c)return!1}return!0}const v=s=>typeof s=="function",E=s=>typeof s=="object",{isArray:H1}=Array,R=(s,t)=>(t?s instanceof HTMLStyleElement:!0)&&"hydrate"in((s==null?void 0:s.dataset)||{});function t1(s,t){let e;const i=o=>{let{length:c}=o;for(let C=0;C<c;C++){const r=o[C];if(r&&Array.isArray(r))i(r);else{const n=typeof r;if(r==null||n==="function"||n==="boolean")continue;n==="string"||n==="number"?(e==null&&(e=""),e+=r):(e!=null&&(t(e),e=null),t(r))}}};i(s),e!=null&&t(e)}const s1=(s,t,e)=>(s.addEventListener(t,e),()=>s.removeEventListener(t,e));class e1{constructor(t,e,i){this.message=e,this.target=t,this.value=i}}class v1 extends e1{}class m1 extends e1{}const S="Custom",_1=null,M1={true:1,"":1,1:1};function Z1(s,t,e,i,o){const{type:c,reflect:C,event:r,value:n,attr:a=L1(t)}=(e==null?void 0:e.name)!=S&&E(e)&&e!=_1?e:{type:e},g=(c==null?void 0:c.name)===S&&c.map,p=n!=null?c==Function||!v(n)?()=>n:n:null;Object.defineProperty(s,t,{configurable:!0,set(h){const f=this[t];p&&c!=Boolean&&h==null&&(h=p());const{error:u,value:H}=(g?b1:V1)(c,h);if(u&&H!=null)throw new v1(this,`The value defined for prop '${t}' must be of type '${c.name}'`,H);f!=H&&(this._props[t]=H??void 0,this.update(),r&&P1(this,r),this.updated.then(()=>{C&&(this._ignoreAttr=a,E1(this,c,a,this[t]),this._ignoreAttr=null)}))},get(){return this._props[t]}}),p&&(o[t]=p()),i[a]={prop:t,type:c}}const P1=(s,{type:t,base:e=CustomEvent,...i})=>s.dispatchEvent(new e(t,i)),L1=s=>s.replace(/([A-Z])/g,"-$1").toLowerCase(),E1=(s,t,e,i)=>i==null||t==Boolean&&!i?s.removeAttribute(e):s.setAttribute(e,(t==null?void 0:t.name)===S&&(t!=null&&t.serialize)?t==null?void 0:t.serialize(i):E(i)?JSON.stringify(i):t==Boolean?"":i),x1=(s,t)=>s==Boolean?!!M1[t]:s==Number?Number(t):s==String?t:s==Array||s==Object?JSON.parse(t):s.name==S?t:new s(t),b1=({map:s},t)=>{try{return{value:s(t),error:!1}}catch{return{value:t,error:!0}}},V1=(s,t)=>s==null||t==null?{value:t,error:!1}:s!=String&&t===""?{value:void 0,error:!1}:s==Object||s==Array||s==Symbol?{value:t,error:{}.toString.call(t)!==`[object ${s.name}]`}:t instanceof s?{value:t,error:s==Number&&Number.isNaN(t.valueOf())}:s==String||s==Number||s==Boolean?{value:t,error:s==Number?typeof t!="number"?!0:Number.isNaN(t):s==String?typeof t!="string":typeof t!="boolean"}:{value:t,error:!0};let I1=0;const N1=s=>{var e;const t=((e=(s==null?void 0:s.dataset)||{})==null?void 0:e.hydrate)||"";return t||"c"+I1++},S1=(s,t=HTMLElement)=>{const e={},i={},o="prototype"in t&&t.prototype instanceof Element,c=o?t:"base"in t?t.base:HTMLElement,{props:C,styles:r}=o?s:t;class n extends c{constructor(){super(),this._setup(),this._render=()=>s({...this._props});for(const g in i)this[g]=i[g]}static get styles(){return[super.styles,r]}async _setup(){if(this._props)return;this._props={};let g,p;this.mounted=new Promise(w=>this.mount=()=>{w(),g!=this.parentNode&&(p!=g?this.unmounted.then(this.update):this.update()),g=this.parentNode}),this.unmounted=new Promise(w=>this.unmount=()=>{w(),(g!=this.parentNode||!this.isConnected)&&(h.cleanEffects(!0)()(),p=this.parentNode,g=null)}),this.symbolId=this.symbolId||Symbol(),this.symbolIdParent=Symbol();const h=d1(()=>this.update(),this,N1(this));let f,u=!0;const H=R(this);this.update=()=>(f||(f=!0,this.updated=(this.updated||this.mounted).then(()=>{try{const w=h.load(this._render),d=h.cleanEffects();return w&&w.render(this,this.symbolId,H),f=!1,u&&!h.isSuspense()&&(u=!1,!H&&T1(this)),d()}finally{f=!1}}).then(w=>{w&&w()})),this.updated),this.update()}connectedCallback(){this.mount(),super.connectedCallback&&super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.unmount()}attributeChangedCallback(g,p,h){if(e[g]){if(g===this._ignoreAttr||p===h)return;const{prop:f,type:u}=e[g];try{this[f]=x1(u,h)}catch{throw new m1(this,`The value defined as attr '${g}' cannot be parsed by type '${u.name}'`,h)}}else super.attributeChangedCallback(g,p,h)}static get props(){return{...super.props,...C}}static get observedAttributes(){const g=super.observedAttributes||[];for(const p in C)Z1(this.prototype,p,C[p],e,i);return Object.keys(e).concat(g)}}return n};function T1(s){const{styles:t}=s.constructor,{shadowRoot:e}=s;if(e&&t.length){const i=[];t1(t,o=>{o&&(o instanceof Element?e.appendChild(o.cloneNode(!0)):i.push(o))}),i.length&&(e.adoptedStyleSheets=i)}}const F=s=>(t,e)=>{q(([i,o]=[])=>((o||!o)&&(o&&u1(o,e)?i=i||!0:(v(i)&&i(),i=null)),[i,e]),([i,o],c)=>c?(v(i)&&i(),[]):[i||t(),o],s)},e5=F(Q),i5=F(X),B1=F(W),k=b("atomico/options");globalThis[k]=globalThis[k]||{sheet:!!document.adoptedStyleSheets};const i1=globalThis[k];new Promise(s=>{i1.ssr||(document.readyState==="loading"?s1(document,"DOMContentLoaded",s):s())});const y1={checked:1,value:1,selected:1},A1={list:1,type:1,size:1,form:1,width:1,height:1,src:1,href:1,slot:1},O1={shadowDom:1,staticNode:1,cloneNode:1,children:1,key:1},N={},D=[];class j extends Text{}const R1=b("atomico/id"),x=b("atomico/type"),A=b("atomico/ref"),o1=b("atomico/vnode"),k1=()=>{};function D1(s,t,e){return n1(this,s,t,e)}const c1=(s,t,...e)=>{const i=t||N;let{children:o}=i;if(o=o??(e.length?e:D),s===k1)return o;const c=s?s instanceof Node?1:s.prototype instanceof HTMLElement&&2:0;if(c===!1&&s instanceof Function)return s(o!=D?{children:o,...i}:i);const C=i1.render||D1;return{[x]:o1,type:s,props:i,children:o,key:i.key,shadow:i.shadowDom,static:i.staticNode,raw:c,is:i.is,clone:i.cloneNode,render:C}};function n1(s,t,e=R1,i,o){let c;if(t&&t[e]&&t[e].vnode==s||s[x]!=o1)return t;(s||!t)&&(o=o||s.type=="svg",c=s.type!="host"&&(s.raw==1?(t&&s.clone?t[A]:t)!=s.type:s.raw==2?!(t instanceof s.type):t?t[A]||t.localName!=s.type:!t),c&&s.type!=null&&(s.raw==1&&s.clone?(i=!0,t=s.type.cloneNode(!0),t[A]=s.type):t=s.raw==1?s.type:s.raw==2?new s.type:o?document.createElementNS("http://www.w3.org/2000/svg",s.type):document.createElement(s.type,s.is?{is:s.is}:void 0)));const C=t[e]?t[e]:N,{vnode:r=N,cycle:n=0}=C;let{fragment:a,handlers:g}=C;const{children:p=D,props:h=N}=r;if(g=c?{}:g||{},s.static&&!c)return t;if(s.shadow&&!t.shadowRoot&&t.attachShadow({mode:"open",...s.shadow}),s.props!=h&&q1(t,h,s.props,g,o),s.children!==p){const f=s.shadow?t.shadowRoot:t;a=$1(s.children,a,f,e,!n&&i,o&&s.type=="foreignObject"?!1:o)}return t[e]={vnode:s,handlers:g,fragment:a,cycle:n+1},t}function j1(s,t){const e=new j(""),i=new j("");let o;if(s[t?"prepend":"append"](e),t){let{lastElementChild:c}=s;for(;c;){const{previousElementSibling:C}=c;if(R(c,!0)&&!R(C,!0)){o=c;break}c=C}}return o?o.before(i):s.append(i),{markStart:e,markEnd:i}}function $1(s,t,e,i,o,c){s=s==null?null:H1(s)?s:[s];const C=t||j1(e,o),{markStart:r,markEnd:n,keyes:a}=C;let g;const p=a&&new Set;let h=r;if(s&&t1(s,f=>{if(typeof f=="object"&&!f[x])return;const u=f[x]&&f.key,H=a&&u!=null&&a.get(u);h!=n&&h===H?p.delete(h):h=h==n?n:h.nextSibling;const w=a?H:h;let d=w;if(f[x])d=n1(f,w,i,o,c);else{const T=f+"";!(d instanceof Text)||d instanceof j?d=new Text(T):d.data!=T&&(d.data=T)}d!=h&&(a&&p.delete(d),!w||a?(e.insertBefore(d,h),a&&h!=n&&p.add(h)):w==n?e.insertBefore(d,n):(e.replaceChild(d,w),h=d)),u!=null&&(g=g||new Map,g.set(u,d))}),h=h==n?n:h.nextSibling,t&&h!=n)for(;h!=n;){const f=h;h=h.nextSibling,f.remove()}return p&&p.forEach(f=>f.remove()),C.keyes=g,C}function q1(s,t,e,i,o){for(const c in t)!(c in e)&&Y(s,c,t[c],null,o,i);for(const c in e)Y(s,c,t[c],e[c],o,i)}function Y(s,t,e,i,o,c){if(t=t=="class"&&!o?"className":t,e=e??null,i=i??null,t in s&&y1[t]&&(e=s[t]),!(i===e||O1[t]||t[0]=="_"))if(s.localName==="slot"&&t==="assignNode"&&"assign"in s)s.assign(i);else if(t[0]=="o"&&t[1]=="n"&&(v(i)||v(e)))F1(s,t.slice(2),i,c);else if(t=="ref")i&&(v(i)?i(s):i.current=s);else if(t=="style"){const{style:C}=s;e=e||"",i=i||"";const r=E(e),n=E(i);if(r)for(const a in e)if(n)!(a in i)&&G(C,a,null);else break;if(n)for(const a in i){const g=i[a];r&&e[a]===g||G(C,a,g)}else C.cssText=i}else{const C=t[0]=="$"?t.slice(1):t;C===t&&(!o&&!A1[t]&&t in s||v(i)||v(e))?s[t]=i??"":i==null?s.removeAttribute(C):s.setAttribute(C,E(i)?JSON.stringify(i):i)}}function F1(s,t,e,i){if(i.handleEvent||(i.handleEvent=o=>i[o.type].call(s,o)),e){if(!i[t]){const o=e.capture||e.once||e.passive?Object.assign({},e):null;s.addEventListener(t,i,o)}i[t]=e}else i[t]&&(s.removeEventListener(t,i),delete i[t])}function G(s,t,e){let i="setProperty";e==null&&(i="removeProperty",e=null),~t.indexOf("-")?s[i](t,e):s[t]=e}const z1=c1("host",{style:"display: contents"}),U1="value",Y1=(s,t)=>{const e=w1(),i=f1();B1(()=>s1(e.current,"ConnectContext",o=>{o.composedPath().at(0)!==o.currentTarget&&s===o.detail.id&&(o.stopPropagation(),o.detail.connect(i))}),[s]),i.current=t},G1=s=>{const t=S1(({value:e})=>(Y1(t,e),z1),{props:{value:{type:Object,value:()=>s}}});return t[U1]=s,t};G1({dispatch(s,t){}});const J1=0,M=1,V=2,I=3,J=4,L=5,$=6,C1=0,K1=2,h1=3,r1=4,l1=L,X1=$,a1=(s,t,e,i)=>{let o;t[0]=0;for(let c=1;c<t.length;c++){const C=t[c++],r=t[c]?(t[0]|=C?1:2,e[t[c++]]):t[++c];C===h1?i[0]=r:C===r1?i[1]=Object.assign(i[1]||{},r):C===l1?(i[1]=i[1]||{})[t[++c]]=r:C===X1?i[1][t[++c]]+=r+"":C?(o=s.apply(r,a1(s,r,e,["",null])),i.push(o),r[0]?t[0]|=2:(t[c-2]=C1,t[c]=o)):i.push(r)}return i},Q1=function(s){let t=M,e="",i="",o=[0],c,C;const r=n=>{t===M&&(n||(e=e.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?o.push(C1,n,e):t===I&&(n||e)?(o.push(h1,n,e),t=V):t===V&&e==="..."&&n?o.push(r1,n,0):t===V&&e&&!n?o.push(l1,0,!0,e):t>=L&&((e||!n&&t===L)&&(o.push(t,0,e,C),t=$),n&&(o.push(t,n,0,C),t=$)),e=""};for(let n=0;n<s.length;n++){n&&(t===M&&r(),r(n));for(let a=0;a<s[n].length;a++)c=s[n][a],t===M?c==="<"?(r(),o=[o],t=I):e+=c:t===J?e==="--"&&c===">"?(t=M,e=""):e=c+e[0]:i?c===i?i="":e+=c:c==='"'||c==="'"?i=c:c===">"?(r(),t=M):t&&(c==="="?(t=L,C=e,e=""):c==="/"&&(t<L||s[n][a+1]===">")?(r(),t===I&&(o=o[0]),t=o,(o=o[0]).push(K1,0,t),t=J1):c===" "||c==="	"||c===`
`||c==="\r"?(r(),t=V):e+=c),t===I&&e==="!--"&&(t=J,o=o[0])}return r(),o},W1=new Map;function l(s){let t=W1;return t=a1(c1,t.get(s)||(t.set(s,t=Q1(s)),t),arguments,[]),t.length>1?t:t[0]}const o5=l`
  <svg
...
`;export{g5 as A,x5 as B,l5 as C,v5 as D,n5 as E,o5 as F,c5 as G,S5 as H,I5 as I,R5 as J,_5 as K,M5 as L,Z5 as M,P5 as N,L5 as O,E5 as P,T5 as Q,H5 as R,r5 as S,N5 as T,k5 as U,O5 as V,p5 as a,S1 as b,f5 as c,f1 as d,m5 as e,i5 as f,e5 as g,l as h,c1 as i,d5 as j,u5 as k,s5 as l,C5 as m,b5 as n,A5 as o,w5 as p,V5 as q,B5 as r,y5 as s,D5 as t,w1 as u,q as v,u1 as w,v as x,h5 as y,a5 as z};
